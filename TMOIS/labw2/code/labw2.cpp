...
int main ()
{
    ...
    for (i = 1; i<=50; i++) { // Заполняем универсум элементами [1;50]
        u.push_back(i);
    }
...
operation:
    ...
    switch(oper)
    {
        ...
        case 6: {
            ...
            for (i = 1; i<=50; i++){ // Проходимся по элементам универсального множества 
                for (j = 0; j<n; j++){ // Проходимся по элементам множества А
        ...
        case 7: {
            ...
            for (i = 1; i<=50; i++){ // Проходимся по элементам унив. множества 
                for (j = 0; j<m; j++){ // Проходимся по элементам множества B
